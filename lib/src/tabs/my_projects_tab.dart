...
class _MyProjectsTab extends State<MyProjectsTab> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ScopedModelDescendant<ProjectModel>(
        builder: (context, child, projectModel){
          return ScopedModelDescendant<UserModel>(
            builder: (context, child, userModel){
              ...
              if(userModel.user.projetos == null || userModel.user.projetos.isEmpty) {
                return Center(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: userModel.user.projetos.reversed.map(
                          (project){
                            if(project.adminId == userModel.user.userId){
                    ...
                    Container(
                      ...
                      child: ListView(
                        scrollDirection: Axis.horizontal,
                        children: userModel.user.projetos.map(
                          (project){
                            if(project.adminId != userModel.user.userId){
                              return GestureDetector(
                                onTap: (){
